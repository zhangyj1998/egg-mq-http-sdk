...
export interface MQClient {
     ...
     */
    constructor(endpoint: string, accessKeyId: string, accessKeySecret: string, securityToken?: string): MQClient
...
export interface MQProducer {
     ...
     * @param topic 主题名字
     */
    constructor(client: MQClient, instanceId: string, topic: string): MQProducer
 ...
 * MQ的消息生产者，支持事务 
 */
export interface MQTransProducer {
     ...
     * @param groupId 客户端GroupID
     */
    constructor(client: MQClient, instanceId: string, topic: string, groupId: string): MQTransProducer
...
export interface MQConsumer {
     ...
     */
    constructor(client: MQClient, instanceId: string, topic: string, consumer: string, messageTag?: string): MQConsumer
